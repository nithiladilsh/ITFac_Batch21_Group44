...
Feature: Category Validation and Retrieval (Standard User)
    ...
    Scenario: API_TC_40 Verify that the API correctly sorts the category list by Name in Ascending order
    ...
    Scenario: API_TC_41 Verify that the API correctly sorts the category list by Parent Category in Ascending order
    ...
    Scenario: API_TC_42 Verify that the API rejects requests containing invalid sort fields
        Given multiple categories exist with different names
    ...
    Scenario: API_TC_43 Verify that the API correctly handles multiple sort parameters
    ...
    Scenario: API_TC_44 Verify that Standard Users are forbidden from deleting categories
    ...
    Scenario: API_TC_45 Verify that Standard Users are forbidden from updating categories
