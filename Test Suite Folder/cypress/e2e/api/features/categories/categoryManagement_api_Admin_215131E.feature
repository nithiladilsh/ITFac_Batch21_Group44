Feature: Category API Validation (Admin)
    ...
    Scenario: API_TC_34 - Prevent deletion of category with active child categories
    ...
    Scenario: API_TC_35 - Verify error on deleting non-existent Category ID
    ...
    Scenario: API_TC_36 - Verify that the API prevents updating a category name to a Null value
    ...
    Scenario: API_TC_37 - Verify that the API prevents updating a category name to one that already exists
    ...
    Scenario: API_TC_38 - Prevent category from becoming its own parent (Circular Reference)
    ...
    Scenario: API_TC_39 - Verify that the API rejects updating a category's parent to a non-existent ID
    ...
    Scenario: API_TC_56 - Verify that deletion for a category is allowed
    ...
    Scenario: API_TC_57 - Verify that update for a category is allowed
        Given I create a category for update testing
